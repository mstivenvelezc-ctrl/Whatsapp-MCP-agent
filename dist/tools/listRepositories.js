...
export function registerListRepositoriesTool(server) {
    server.registerTool("list_repositories", {
        title: "Listar repositorios",
        description: "Lista los repositorios del usuario autenticado, ordenados por última actualización.",
        inputSchema: {
        ...
        try {
            ...
            const lines = data
                .map((repo) => `- ${repo.full_name} ${repo.private ? "(privado)" : "(público)"}` +
...
//# sourceMappingURL=listRepositories.js.map