...
export const findOrCreateContactTool = defineTool({
    ...
    description: "Busca en el CRM el contacto asociado al teléfono de WhatsApp del usuario; si no existe, lo crea " +
...
//# sourceMappingURL=findOrCreateContact.tool.js.map