...
export const listAvailableSlotsTool = defineTool({
    ...
    async execute(input, { crmClient }) {
        try {
            ...
            throw new ToolExecutionError("list_available_slots", "No se pudieron consultar los horarios disponibles en el CRM", error);
        }
    },
});
//# sourceMappingURL=listAvailableSlots.tool.js.map