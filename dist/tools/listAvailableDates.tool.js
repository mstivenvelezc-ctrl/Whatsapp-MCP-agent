...
export const listAvailableDatesTool = defineTool({
    ...
    async execute(_input, { crmClient }) {
        try {
            ...
            throw new ToolExecutionError("list_available_dates", "No se pudieron consultar las fechas disponibles en el CRM", error);
        }
    },
});
//# sourceMappingURL=listAvailableDates.tool.js.map