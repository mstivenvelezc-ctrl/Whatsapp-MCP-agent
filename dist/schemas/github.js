...
export const repoNameSchema = z
    ...
    .regex(/^[a-zA-Z0-9-]+$/, "Nombre inválido: solo se permiten letras, números y guiones (sin espacios ni símbolos).");
...
export const ownerSchema = z
    ...
    .regex(/^[a-z\d](?:[a-z\d]|-(?=[a-z\d])){0,38}$/i, "Owner inválido: usa un usuario/organización válido de GitHub (letras, números y guiones, sin empezar ni terminar en guion).");
